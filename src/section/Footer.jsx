...
export default function Footer() {
  ...
  return (
    <div
      ref={info}
      className="bg-[#A0C49D] border-2 m-3 rounded-xl sm:p-5 flex sm:flex-row-reverse 2s:flex-col justify-around items-center 2s:gap-14 sm:gap-0"
    >
      <RevealRtl>
        <div className="flex flex-col items-end gap-1">
          <h1 className="mb-2 text-[50px]">ارتباط با ما</h1>
          <div className="flex gap-1 flex-row-reverse sm:text-[25px]">
            <IoCallOutline />
            <p>: تماس با ما</p>
            <p>0996 281 2008</p>
          </div>
