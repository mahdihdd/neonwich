  ...
  return (
    ...
    >
      ...
      <RevealRtl style="h-full  sm:w-1/4 mx-8 mt-4 sm:mt-0 sm:mx-0 flex  justify-center items-center sm:relative grow sm:grow-0 sm:bg-[#F7FFE5]">
        <div className="w-[300px] rounded-3xl  2s:mt-[-55px] 2s:w-[290px] s:w-[400px]   h-[200px] sm:w-[600px] sm:h-[400px]  sm:top-5 sm:right-2 z-10 absolute  md:right-10 lg:right-28 lg:top-12 xl:right-36 xl:top-20 2xl:right-80 xxl:right-96">
          <img
